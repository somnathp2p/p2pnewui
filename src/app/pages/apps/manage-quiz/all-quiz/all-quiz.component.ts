...
export class AllQuizComponent implements OnInit, AfterViewInit {
...
{ label: 'Topic', property: 'topic', type: 'text', visible: false },
{ label: 'Sub Topic', property: 'subtopic', type: 'text', visible: false },
{ label: 'Category', property: 'category', type: 'text', visible: true },
{ label: 'Questions', property: 'Question', type: 'text', visible: true, cssClasses: ['text-secondary', 'font-medium'] },
{ label: 'Quiz Type', property: 'QType', type: 'text', visible: false, cssClasses: ['text-secondary', 'font-medium'] },
